...
const Hero =({titleData,createCampaign}) =>{
  ...
  return(
    ...
    auto=compress&amp;cs=tinysrgb@amp;dpr=2&amp;h=750&amp;w=1260" 
...
<path
 ...
 <div className='relative px-4 py-16 mx-auto overflow-hidden sm:max-w-xl
     ...
     text-white sm:test-5xl sm:leading-none'>
        FundRaise <br className='hidden md:block'/><br className='hidden md:block'/>
        The Ultimate CrowdFund
     </h2>
...
<br />
         It can increase transparency, as all transactions are publicly visible and cannot be manipulated.
         </p>
         <a href="/"
         aria-label=''
        ...
        <div className='bg-white rounded shadow-2xl p-7 sm:p-10'>
           ...
           <form action="">
            ...
            <label htmlFor="firstName"
             className='inline-box mb-1 font-medium'
             >Title</label>
        ...
        font-bold tracking-wide text-white transition duration-200 rounded
        shadow-md bg-deep-purple-accent-400 hover:bg-deep-purple-accent-700
        focus:shadow-outline focus:outline-none newColor bg-green-400 text-xl'
        >
            Create Campaign
        </button>
        </div>
