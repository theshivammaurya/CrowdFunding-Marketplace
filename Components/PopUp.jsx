...
<>
  <div className='justify-center items-center flex overflow-x-hidden
    overflow-y-auto fixed inset-0 z-50 outline-none foocus:outline-none'>
...
<span className='bg-transparent text-black opacity-5 h-6 w-6 text-2xl block outline-none focus:outline-none'>
  x
   ...
   <p className='my-4 text-slate-500 text-lg leadiing-relaxed'>
   {donate.description}
   </p>
...
name="firstName"
 ...
 <button className='text-red-500 background-transparent font-bold uppercase px-6 py-2 text-sm
...
<button className='bg-green-700 text-white active:bg-emerald-600 font-bold uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none
focus:outline-none mr-1 mb-1 ease-linear transiition-all duration-150 '
type="button"
